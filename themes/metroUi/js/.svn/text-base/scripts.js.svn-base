...
$(function() {
    ...
    var b = $("a.change_color");
    $("a.change_color_outside").on("click", this, function(f) {
        var h = this;
        current_box = $(this).closest(".box");
        var g = $(this).offset();
        f.stopPropagation();
        $(".background_changer").css({
            left: g.left - $("#colors_pallete ul").outerWidth() + $(this).outerWidth(),
            top: g.top + $(this).outerHeight()
        });
        b.click();
    });
    $(".background_changer li a").on("click", this, function(h) {
        var g = $(this),
                f = g.attr("data-color");
